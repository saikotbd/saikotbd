...
$nitropack_functions_file = '/home/saikotbd/public_html/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/home/saikotbd/public_html/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_dbe8dfd22973cf5ab16221e3233d8b28' );
