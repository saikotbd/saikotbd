	...
	class Device_Slider extends Module_Base {
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'mobile-dark' => esc_html__( 'Mobile Dark', 'bdthemes-element-pack' ),
		...
		protected function render_footer() {
            ...
            <div class="bdt-device-slider-device">
                <img src="<?php echo BDTEP_ASSETS_URL; ?>images/devices/<?php echo esc_attr( $device_type ); ?>.svg"
                     alt="Device Slider">
            </div>
            </div>
            </div>
