...
class Breadcrumbs extends Module_Base {
	...
	public function get_icon() {
		return 'bdt-wi-breadcrumbs bdt-new';
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Breadcrumbs', 'bdthemes-element-pack' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => "'/'",
				'selectors' => [
					'{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>:nth-child(n+2):not(.bdt-first-column)::before' => 'content: {{VALUE}};',
				],
			]
		);
 		...
 		$this->add_control(
			'home_icon',
			[
				'label' => __( 'Home Icon', 'bdthemes-element-pack' ),
		...
		$this->add_control(
			'home_icon_color',
			[
				'label' => __( 'Home Icon Color', 'bdthemes-element-pack' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb .bdt-breadcrumbs-home-icon' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>*>* ,
							 {{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>:nth-child(n+2):not(.bdt-first-column)::before',
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>*>*' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>*>*' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>*>*' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>*>*:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>*>*:hover',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-breadcrumb>:last-child>span',
				// 'scheme' => Schemes\Typography::TYPOGRAPHY_2,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bdt-breadcrumb>:last-child>span' => 'color: {{VALUE}}!important;',
				],
			]
		);
		 ...
		 $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-breadcrumb>:last-child>span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-breadcrumb>:last-child>span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-breadcrumb>:last-child>span:hover' => 'color: {{VALUE}}!important;',
				],
			]
		);
		...
		$this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .bdt-breadcrumb>:last-child>span:hover',
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>:nth-child(n+2):not(.bdt-first-column)::before' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>:nth-child(n+2):not(.bdt-first-column)::before',
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>:nth-child(n+2):not(.bdt-first-column)::before' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-breadcrumbs-wrapper .bdt-breadcrumb>:nth-child(n+2):not(.bdt-first-column)::before' => 'margin: 0px {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	private function rooten_breadcrumbs($align, $home_icon) {
	    ...
	    if (is_home() || is_front_page()) {
	        ...
	        if (is_category()) {
	            ...
	            $output[] = $before . esc_html__('Category', 'rooten') . ': ' . esc_html(single_cat_title('', false)) . '' . $after;

	        } elseif ( is_search() ) {
	            $output[] = $before . esc_html__('Search', 'rooten') . $after;
	        } elseif ( is_day() ) {
	            ...
	            $output[] = $before . esc_html__('Tag', 'rooten') . ': ' . esc_html(single_tag_title('', false)) . $after;
	        } elseif ( is_author() ) {
	            global $author;
	            $userdata = get_userdata($author);
	            $output[] = $before . esc_html__('Articles by', 'rooten') . ' ' . esc_html($userdata->display_name) . $after;
	        } elseif ( is_404() ) {
	            $output[] = $before . esc_html__('Error 404', 'rooten') . $after;
	        }
	        if ( get_query_var('paged') ) {
	            $output[] = ' (' . esc_html__('Page', 'rooten') . ' ' . esc_html(get_query_var('paged')) . ')';
	        }
	        $output[] = '</ul>';
	    }
	...
	protected function render() {
		...
		if (!empty($settings['home_icon']['value'])){
			$home_icon = '<span class="bdt-breadcrumbs-home-icon"><i aria-hidden="true" class="'.$settings['home_icon']['value'].'"></i></span>';
		}
