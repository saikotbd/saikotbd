...
class AdvancedButton extends Module_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button .bdt-ep-button-icon i' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button:hover .bdt-ep-button-icon i' => 'color: {{VALUE}};',
