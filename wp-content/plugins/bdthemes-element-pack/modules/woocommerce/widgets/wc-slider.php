	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-wc-slider .bdt-slideshow-items .bdt-wc-slider-title' => 'color: {{VALUE}}; -webkit-text-stroke-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-wc-slider-arrows-ncx: {{SIZE}}px;'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-wc-slider-arrows-ncy: {{SIZE}}px;'
				],
				'conditions'   => [
					'terms' => [
						[
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-wc-slider-dots-nnx: {{SIZE}}px;'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-wc-slider-dots-nny: {{SIZE}}px;'
				],
				'conditions'   => [
					'terms' => [
						[
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-wc-slider-both-ncx: {{SIZE}}px;'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-wc-slider-both-ncy: {{SIZE}}px;'
				],
				'conditions'   => [
					'terms' => [
						[
