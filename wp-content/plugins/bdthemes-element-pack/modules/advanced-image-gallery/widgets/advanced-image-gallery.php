...
class Advanced_Image_Gallery extends Module_Base {
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'ep-justified-gallery', 'tilt', 'bdt-uikit-icons' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-advanced-image-gallery.bdt-spotlite-mode:hover .bdt-gallery-item:not(:hover):after' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'advanced_spotlite_mode' => 'yes',
				],
		...
		$this->add_control(
            ...
            [
                ...
                'selectors'   => [
                    '{{WRAPPER}} .bdt-advanced-image-gallery .bdt-gallery-item .bdt-overlay-default' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);'
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-advanced-image-gallery-arrows-ncx: {{SIZE}}px;'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-advanced-image-gallery-arrows-ncy: {{SIZE}}px;'
				],
				'conditions'   => [
					'terms' => [
						[
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-advanced-image-gallery-dots-nnx: {{SIZE}}px;'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-advanced-image-gallery-dots-nny: {{SIZE}}px;'
				],
				'conditions'   => [
					'terms' => [
						[
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-advanced-image-gallery-both-ncx: {{SIZE}}px;'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--ep-advanced-image-gallery-both-ncy: {{SIZE}}px;'
				],
				'conditions'   => [
					'terms' => [
						[
