...
class Social_Proof extends Module_Base {
    ...
    public function get_style_depends() {
        if ($this->ep_is_edit_mode()) {
            ...
            return [ 'element-pack-font', 'ep-social-proof' ];
        }
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#e7e7e7',
				'selectors' => [
					'{{WRAPPER}} .bdt-social-proof .bdt-rating .bdt-rating-item i.ep-star-empty' => 'color: {{VALUE}};',
				]
			]
        );
    ...
    public function render_rating($rating = 0) {
		...
		<div class="bdt-social-proof-rating">
			<ul class="bdt-rating bdt-grid bdt-grid-collapse bdt-rating-<?php echo esc_attr($rating); ?>" bdt-grid>
                ...
                if ( $intpart <= 5 ) {
                    for ( $i=0; $i<$intpart; $i++ )
                    {echo '<li class="bdt-rating-item"><i class="ep-star-full" aria-hidden="true"></i></li>';}
                }

                if ( $fraction >= 0.5 ) {
                    echo '<li class="bdt-rating-item"><i class="ep-star-half" aria-hidden="true"></i></li>';
                }

                if ( $unrated > 0 ) {
                    for ( $j=0; $j<$unrated; $j++ ) {
                    	echo '<li class="bdt-rating-item"><i class="ep-star-empty" aria-hidden="true"></i></li>';
                    }
                }
                ?>
			</ul>
                    ...
                    <a class="bdt-social-proof-item bdt-social-proof-<?php echo esc_html($social) ?> bdt-flex bdt-flex-middle" href="<?php echo esc_url($pageUrl) ?>" target="_blank">
                        ...
                        <div>
                            ...
                            <div class="bdt-social-icon">
                                <i class="ep-<?php echo esc_html($social) ?>" aria-hidden="true"></i>
                            </div>
                            <?php endif; ?>
