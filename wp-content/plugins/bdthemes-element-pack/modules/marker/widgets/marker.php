	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-marker-wrapper .bdt-marker > svg, {{WRAPPER}} .bdt-marker-wrapper .bdt-marker > img' => 'width: calc({{SIZE}}{{UNIT}} - 12px); height: auto;',
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>			
		    ...
		    foreach ($settings['markers'] as $marker) {
				...
				$this->add_render_attribute('marker', 'class', 'bdt-marker-item bdt-position-absolute bdt-transform-center bdt-marker bdt-icon elementor-repeater-item-' . esc_attr($marker['_id']), true);
