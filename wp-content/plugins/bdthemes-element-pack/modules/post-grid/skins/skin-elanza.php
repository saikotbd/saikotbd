	  		...
	  		<div class="bdt-grid bdt-grid-<?php echo esc_attr($settings['column_gap']); ?>" bdt-grid>
				...
				while ($wp_query->have_posts()) :
					...
					<?php endif; ?>
									...
									<?php if (1 < $bdt_count) : 
										$item_columns   = ' bdt-width-1-' . esc_attr($settings['secondary_columns']) . '@m bdt-width-1-' . esc_attr($settings['secondary_columns_tablet']) . '@s bdt-width-1-' . esc_attr($settings['secondary_columns_mobile']) ;
										?>
