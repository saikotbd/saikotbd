	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'  => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .bdt-post-block-modern .left-part.bdt-post-block-modern-item .bdt-post-block-modern-title' => 'margin-top: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'title' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-post-block-modern .bdt-post-block-modern-read-more svg *' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-post-block-modern .bdt-post-block-modern-read-more:hover svg' => 'fill: {{VALUE}};',
				],
			]
		);
