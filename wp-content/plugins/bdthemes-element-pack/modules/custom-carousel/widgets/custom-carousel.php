	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}.bdt-ep-active-item--yes .swiper-slide.bdt-custom-carousel-item.bdt-transition-toggle.swiper-slide-active:before' => 'background: {{VALUE}}',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}.bdt-ep-active-item--yes .swiper-slide.bdt-custom-carousel-item.bdt-transition-toggle.swiper-slide-active' => 'background: {{VALUE}}',
				],
				'condition' => [
					'active_item_mode' => 'yes',
					'centered_slides' => 'yes',
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}}.bdt-ep-active-item--yes .swiper-slide.bdt-custom-carousel-item.bdt-transition-toggle.swiper-slide-active' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.bdt-ep-active-item--yes .swiper-slide.bdt-custom-carousel-item' => 'opacity: {{SIZE}};',
				],
				'condition' => [
					'active_item_mode' => 'yes',
					'centered_slides' => 'yes',
	...
	protected function print_slide( array $slide, array $settings, $element_key ) {		
		...
		if ( 'bdt-custom-content' === $settings['_skin'] ) {
			...
			$this->add_render_attribute( $element_key . '-image', [
				'class' => 'bdt-custom-carousel-thumbnail bdt-image-mask',
