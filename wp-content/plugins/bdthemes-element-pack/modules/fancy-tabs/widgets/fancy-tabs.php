...
class Fancy_Tabs extends Module_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-tab-content-wrapper.bdt-content-height-fixed .bdt-fancy-tabs-content' => 'max-height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-tab-content-wrapper.bdt-content-height-fixed' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
            ...
            [
                ...
                'selectors'   => [
                    '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);'
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item'     => 'border-radius: {{VALUE}}; overflow: hidden;',
				],
				'condition' => [
					'tabs_item_radius_advanced_show' => 'yes',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover'  => 'border-color: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item.active',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item.active'  => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'tabs_item_border_border!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper svg *' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator'  => 'after',
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'default'     => '75% 25% 43% 57% / 46% 29% 71% 54%',
				'selectors'   => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper'     => 'border-radius: {{VALUE}}; overflow: hidden;',
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper img' => 'border-radius: {{VALUE}}; overflow: hidden;'
				],
				'condition' => [
					'icon_radius_advanced_show' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper i'   => 'transform: rotate({{SIZE}}{{UNIT}});',
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper img' => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper' => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'  => Controls_Manager::SWITCHER,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-icon-wrapper' => 'width: 100%;box-sizing: border-box;',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'      => 'css_filters',
				'selector'  => '{{WRAPPER}} .bdt-fancy-tabs img',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs img' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs img' => 'transition-duration: {{SIZE}}s',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper svg *' => 'fill: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper'  => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'icon_border_border!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper i'   => 'transform: rotate({{SIZE}}{{UNIT}});',
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper img' => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper' => 'transform: rotate({{SIZE}}{{UNIT}});',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper img',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item:hover .bdt-icon-wrapper img' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item.active .bdt-icon-wrapper' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-item.active .bdt-icon-wrapper svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-title' => 'color: {{VALUE}}; -webkit-text-stroke-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-title' => 'padding-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-sub-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-sub-title' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'bdthemes-element-pack' ),
				'selector' => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-sub-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-text' => 'padding-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'bdthemes-element-pack' ),
				'selector' => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-text',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tabs-button a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tabs-button a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tabs-button a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tabs-button a'     => 'border-radius: {{VALUE}}; overflow: hidden;',
				],
				'condition' => [
					'border_radius_advanced_show' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tabs-button a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tabs-button a:hover'  => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tabs-button a:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tabs-button a:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute(
			[
				'tabs' => [
					'id' => 'bdt-fancy-tabs-' . $this->get_id(),
					'class' => 'bdt-fancy-tabs',
					'data-settings' => [
						wp_json_encode(array_filter([
					        'tabs_id' => 'bdt-fancy-tabs-' . $this->get_id(),
	...
	public function tabs_content() {
		...
		if ( $settings['tabs_content_height_show'] == 'yes') {
			$this->add_render_attribute('tabs-content-wrapper', 'class', 'bdt-content-height-fixed');
		}
		$this->add_render_attribute('tabs-content-wrapper', 'class', 'bdt-tab-content-wrapper');
		...
		?>
			...
			<?php foreach ( $settings['tabs'] as $index => $item ) : 
				...
				if ($tab_id    == 'bdt-tab-'. $active_item . esc_attr($id)) {
					$this->add_render_attribute( 'tabs-content', 'class', 'bdt-fancy-tabs-content active', true );
				} else {
					$this->add_render_attribute( 'tabs-content', 'class', 'bdt-fancy-tabs-content', true );
				}

				$this->add_render_attribute('fancy_title_tags', 'class', 'bdt-fancy-tab-title', true);
				...
				<div id="<?php echo esc_attr($tab_id); ?>" <?php echo ( $this->get_render_attribute_string( 'tabs-content' ) ); ?>>
					...
					<?php if ( $item['tab_sub_title'] && ( 'yes' == $settings['show_sub_title'] ) ) : ?>
						<div class="bdt-fancy-tab-sub-title">
						...
						<div class="bdt-fancy-tabs-button">
							<?php if ( '' !== $item['button_link']['url'] ) : ?>
								...
								<a <?php echo $this->get_render_attribute_string('link_key'); ?>
								 href="<?php echo esc_url( $item['button_link']['url'] ); ?>">
							<?php endif; ?>
			...
			<div <?php echo ( $this->get_render_attribute_string( 'tab-settings' ) ); ?>>
				<div class="bdt-grid bdt-grid-<?php echo esc_attr($settings['column_gap']); ?> bdt-child-width-1-<?php echo esc_attr($mobile_cols); ?> bdt-child-width-1-<?php echo esc_attr($tablet_cols); ?>@s bdt-child-width-1-<?php echo esc_attr($desktop_cols); ?>@l" bdt-grid>
					...
					<?php foreach ( $settings['tabs'] as $index => $item ) :
						...
						$active_item = $this->activeItem($settings['fancy_tab_active_item'], count($settings['tabs']));
						if ($tab_id    == 'bdt-tab-'. $active_item . esc_attr($id)) {
							$this->add_render_attribute( 'tabs-item', 'class', 'bdt-fancy-tabs-item active', true );
						} else {
							$this->add_render_attribute( 'tabs-item', 'class', 'bdt-fancy-tabs-item', true );
						}
						...
						if ( $has_image and 'image' == $item['icon_type'] ) {
							$this->add_render_attribute( 'image-icon', 'src', $item['image']['url'], true );
							$this->add_render_attribute( 'image-icon', 'alt', $item['tab_title'], true );
						}
						
						?>
						<div>
							<div <?php echo ( $this->get_render_attribute_string( 'tabs-item' ) ); ?> data-id="<?php echo esc_attr($tab_id); ?>">
								<a class="bdt-fancy-tabs-icon-box" href="javascript:void(0);" data-tab-index="<?php echo esc_attr($index); ?>" >
