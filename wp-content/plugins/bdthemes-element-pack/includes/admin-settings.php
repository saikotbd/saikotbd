      ...
      <script>
          jQuery(document).ready(function ($) {
              ...
              jQuery('#element_pack_active_modules_page a.ep-active-all-widget').click(function () {
                  // jQuery('#element_pack_active_modules_page .checkbox').attr('checked', 'checked').prop("checked", true);
              ...
              jQuery('#element_pack_third_party_widget_page a.ep-active-all-widget').click(function () {
                  // jQuery('#element_pack_third_party_widget_page .checkbox').attr('checked', 'checked').prop("checked", true);
